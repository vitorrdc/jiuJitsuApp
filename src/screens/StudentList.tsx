  ...
  return (
    <View className="bg-background flex-1 items-center">
      ...
      >
        ...
        <View className="flex-row justify-between items-center bg-zinc-600 w-full rounded-lg mt-2 px-4 py-2">
          <Text className="text-white">Fernando Barbosa</Text>
          <TouchableOpacity
            className="bg-blue-500 rounded-lg p-2"
            activeOpacity={0.9}
          >
        ...
        <View className="flex-row justify-between items-center bg-zinc-600 w-full rounded-lg mt-2 px-4 py-2">
          <Text className="text-white">Danilo Silva</Text>
          <TouchableOpacity
            className="bg-blue-500 rounded-lg p-2"
            activeOpacity={0.9}
          >
